const CACHE='lampisteria-cr-shell-v3-20260923-pdf';
const CORE=['./','./index.html','./manifest.webmanifest','./app-icon-192.png','./app-icon-512.png','./apple-touch-icon.png'];
...
self.addEventListener('fetch',event=>{
 ...
 const staticOwn=own&&(req.mode==='navigate'||/\/(index\.html|manifest\.webmanifest|(app-)?icon-(192|512)\.png|apple-touch-icon\.png)$/.test(url.pathname));
